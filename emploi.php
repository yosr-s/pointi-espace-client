...
$req1 = $bdd->query("SELECT * FROM emploi");
?>
<!DOCTYPE html>
<html lang="en">
...
?> 
                  <tr>
                    <th scope="row">1ère séance</th>
                    <td><?php echo $donnees1['dps'] ?>-<?php echo $donnees1['fps'] ?></td>
                    <td><?php echo $donnees1['dps'] ?>-<?php echo $donnees1['fps'] ?></td>
                    <td><?php echo $donnees1['dps'] ?>-<?php echo $donnees1['fps'] ?></td>
                    <td><?php echo $donnees1['dps'] ?>-<?php echo $donnees1['fps'] ?></td>
                    <td><?php echo $donnees1['dps'] ?>-<?php echo $donnees1['fps'] ?></td>
                  ...
                  <tr>
                    <th scope="row">2ème séance</th>
                    <td><?php echo $donnees1['dds'] ?>-<?php echo $donnees1['fds'] ?></td>
                    <td><?php echo $donnees1['dds'] ?>-<?php echo $donnees1['fds'] ?></td>
                    <td><?php echo $donnees1['dds'] ?>-<?php echo $donnees1['fds'] ?></td>
                    <td><?php echo $donnees1['dds'] ?>-<?php echo $donnees1['fds'] ?></td>
                    <td><?php echo $donnees1['dds'] ?>-<?php echo $donnees1['fds'] ?></td>
